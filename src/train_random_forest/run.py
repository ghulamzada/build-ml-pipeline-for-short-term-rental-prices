...
def go(args):
    """
    This function includes the follwoing steps:
        - Loading dataset
        - Train test split (data segregation)
        - Fitting data into the model
        - Creating prediction
        - Saving the model in W&B
        - Creating/Ploting feature importance
        - Creating data transformation
        - Putting all steps into a pipeline
    """
...
def plot_feature_importance(pipe, feat_names):
    """
    This function plots the feature importance of trained model.
    """
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    """
    This function includes the data transformation and training steps.
    """
